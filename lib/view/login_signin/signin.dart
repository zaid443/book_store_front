        ...
        child: SingleChildScrollView(
          child: Column(
              children: [
                ...
                Text('Sign in to Continue', style: GoogleFonts.cairo(fontSize: 24,
      ...
      Padding(
          ...
          child:TextButton(
            ...
            child: const BorderedContainer(
                child: MyButtonText( text:'Sign in' )),
          ),),
              ...
              child: TextButton(
                ...
                Padding(
                  ...
                  child: TextButton(
                    ...
                    child: Text('Don\'t have any account? $register Register ' ,style: GoogleFonts.cairo(fontSize: 18,
